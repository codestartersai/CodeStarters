...
-- Disable RLS on content & admin tables that are already protected by our server-side verifyAdminUser middleware
...
-- Reload PostgREST schema cache so newly added columns and tables are instantly recognized
